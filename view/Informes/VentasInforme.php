<?php
    ...
    for($i=0;$i<=sizeof($_SESSION['Permisos'])-1;$i++){
      if($_SESSION['Permisos'][$i]['idPermiso']==17){
	...
	<div class="row">
      ...
      <div class="panel panel-default">
          <div class="panel-heading">
            <i class="glyphicon glyphicon-signal"></i> Estadistica Ventas
          </div>
       ...
       <div class="tab-content">
        <div id="PorVendedor" class="tab-pane fade in active"> 
          <div class="row">
           ...
           <div class="row">
            <div class="col-lg-7" id='ContGraficaVentas'>
              <div id='Canvas'>
                  <div class="row">
                  <div class="col-lg-10">
                    <h3>Vendedores</h3>
            ...
            <div class="col-lg-5">
              ...
              <table class="table table-striped"><thead><th>Acción</th><th>Cedula</th><th>Empleado</th><th>Tipo</th></thead><tbody id='tblVendedores'></tbody></table>
              </div>
            </div>                                         
		     </div>
        </div> 
        <div id="Ciudades" class="tab-pane fade">
          <div class="row">
            <div class="col-lg-5" id='ContCiudades'>
              <label>Año</label>
...
<script type="text/javascript">
    ...
    VendedoresAsociados();
    var ChartJs;
    PintarTblVendedores(1);
    PintarTblVendedores(2);
    ...
    function DdlCompania()
    {
     ...
     function PintarTblVendedores(Tipo){
          switch(Tipo){
            case 1:
               var parametros = {
...
function CargarTablaVendores(){
 setTimeout(function(){ document.getElementById("ContTblVendedores").style.height=((document.getElementById('ContGraficaVentas').offsetHeight)-71)+"px"; 
   }, 500);
}
function CargarTablaCiudades(){
 setTimeout(function(){  document.getElementById("ContTblCiudades").style.height=((document.getElementById('ContCiudades').offsetHeight-74))+"px"; 
   }, 500);
}
</script>
