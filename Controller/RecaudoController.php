...
$objRecaudo= new clsRecaudoController();
if(isset($_POST['txtMes'])){
if($_POST['txtMes']=='-1'){
				$Tipo='InformeRecaudoMes';
}else{
				$Tipo='InformeRecaudoDiario';
}
}
if(isset($_POST['btnPintarEstructuraPorVendedor'])){
$objRecaudo->CrearEstructuraGraficaRecaudo($Tipo,$Tipo.'Result','inforGeneralPorVendedor','Vendedor');
}
if(isset($_POST['btnJsInformeVendedor'])){

$objRecaudo->VentasGraficaJs($Tipo,$Tipo.'Result','inforGeneralPorVendedor','Vendedor');
}

if(isset($_POST['txtMes'])){
if($_POST['txtMes']=='-1'){
				
				$Tipo='InformeRecaudoMesCiudad';
}else{
				$Tipo='InformeRecaudoDiarioCiudad';
}
}

if(isset($_POST['btnPintarEstructuraPorCiudades'])){
$objRecaudo->CrearEstructuraGraficaRecaudo($Tipo,$Tipo.'Result','inforGeneralPorVendedorCiudad','Ciudad');
}
if(isset($_POST['btnJsInformeCiudades'])){
$objRecaudo->VentasGraficaJs($Tipo,$Tipo.'Result','inforGeneralPorVendedorCiudad','Ciudad');
}


if(isset($_POST['btnPintarTblVendedores'])){
$objRecaudo->PintarTablaVendedores(1,'ConsultarVendedores','ConsultarVendedoresResult');
}
if(isset($_POST['btnPintarTblCiudades'])){
$objRecaudo->PintarTablaVendedores(2,'CarteraPorCiudad','CarteraPorCiudadResult');
}
if(isset($_POST['btnVendedoresAsociados'])){
$objRecaudo->VendedoresAsociados();

}
$objRecaudo=null;
class clsRecaudoController
{	
	private $idCanvas;
	...
	public function CrearEstructuraGraficaRecaudo($WebService,$TipoWebService,$idCanvas,$strParametroTipo){
		$this->strAnno=trim($_POST['txtAnno']);
		$this->strMes=trim($_POST['txtMes']);
		$this->strVendedor=trim($_POST['txtVendedor']);
